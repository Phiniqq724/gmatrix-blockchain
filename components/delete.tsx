...
export const Delete = ({ item, reload }: DeleteProps) => {
  ...
  return (
    <>
      <button role="cell" className="hover:text-lavender-blue-500 active:text-lavender-blue-400" onClick={async () => await delItem(item)}>
        <svg width="16" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 29 29" fill="currentColor">
          <g>
            ...
            <path fill="none" d="M14.5,6.26H5.19l1.26,17.82c.09,1.21,1.09,2.14,2.3,2.14h11.49c1.21,0,2.22-.94,2.3-2.14l1.26-17.82h-9.31Z" />
            ...
            <path className="dark:text-black" d="M11.29,8.71c-.55,0-1,.45-1,1v12.81c0,.55.45,1,1,1s1-.45,1-1v-12.81c0-.55-.45-1-1-1Z" />
            <path className="dark:text-black" d="M17.71,8.71c-.55,0-1,.45-1,1v12.81c0,.55.45,1,1,1s1-.45,1-1v-12.81c0-.55-.45-1-1-1Z" />
          </g>
        </svg>
      </button>
