    ...
    <div className="w-full max-w-2xl mt-8 dark:text-white" role="table">
      ...
      <div className="py-2" role="rowgroup">
        ...
        <div
          ...
          role="row"
        >
          <span role="cell" className="p-1 flex align-center min-w-max">
            {/* {index + 1} ) */}
          </span>
          ...
          <div role="cell" className="flex gap-2 justify-center align-middle">
            {/* {url !== undefined ? ( */}
            <a aria-label="Open data" rel="noopener noreferrer" target="_blank" className="hover:text-lavender-blue-500 active:text-lavender-blue-400">
