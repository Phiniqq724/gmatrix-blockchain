  ...
  return (
    <React.Fragment>
      <div className="w-64 block">
        <aside id="default-sidebar" className="z-40 fixed h-screen transition-transform -translate-x-full sm:translate-x-0">
          <div className="h-full px-3 py-4 overflow-y-auto bg-[#0832DE] space-y-[65px]  ">
            <div className="flex items-center justify-start">
              <Image src={IMGProfile} alt="" />
              <h1 className="font-normal text-white text-[24px] mx-6">Nexbook</h1>
            </div>
            <div className="space-y-[440px] font-medium ">
              <ul className="space-y-2">
                <li>
                  <Link href="/userDashboard" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-blue-600 duration-500 group">
                ...
                <li>
                  <Link href="/userBookCollection" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-blue-600 duration-500 group">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                    ...
                    <span className="flex-1 ms-3 whitespace-nowrap text-lg">Collection</span>
                  </Link>
                </li>
                <li>
                  <Link href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-blue-600 duration-500 group">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                    ...
                    <span className="flex-1 ms-3 whitespace-nowrap text-lg">Favorite</span>
                  </Link>
                </li>
              </ul>
              <ul className="space-y-2">
...
export const AdminSidebar = () => {
  ...
  return (
    <React.Fragment>
      <div className="w-64 block">
        <aside id="default-sidebar" className="top-0 left-0 z-40  fixed h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
          <div className="h-full px-3 py-4 overflow-y-auto bg-[#0832DE] space-y-[65px] flex flex-col ">
            ...
            <div className="space-y-[440px] font-medium ">
              <ul className="space-y-2">
                <li>
                  <Link href="/admin/adminDashboard" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-blue-600 duration-500 group">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                        d="M9 21V13.6C9 13.0399 9 12.7599 9.109 12.546C9.20487 12.3578 9.35785 12.2049 9.54601 12.109C9.75993 12 10.04 12 10.6 12H13.4C13.9601 12 14.2401 12 14.454 12.109C14.6422 12.2049 14.7951 12.3578 14.891 12.546C15 12.7599 15 13.0399 15 13.6V21M2 9.5L11.04 2.72C11.3843 2.46181 11.5564 2.33271 11.7454 2.28294C11.9123 2.23902 12.0877 2.23902 12.2546 2.28295C12.4436 2.33271 12.6157 2.46181 12.96 2.72L22 9.5M4 8V17.8C4 18.9201 4 19.4802 4.21799 19.908C4.40974 20.2843 4.7157 20.5903 5.09202 20.782C5.51985 21 6.0799 21 7.2 21H16.8C17.9201 21 18.4802 21 18.908 20.782C19.2843 20.5903 19.5903 20.2843 19.782 19.908C20 19.4802 20 18.9201 20 17.8V8L13.92 3.44C13.2315 2.92361 12.8872 2.66542 12.5091 2.56589C12.1754 2.47804 11.8246 2.47804 11.4909 2.56589C11.1128 2.66542 10.7685 2.92361 10.08 3.44L4 8Z"
                        stroke="white"
                ...
                <li>
                  <Link href="/admin/userData" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-blue-600 duration-500 group w-full">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                    ...
                    <span className="flex-1 ms-3 whitespace-nowrap text-lg text-start">Users</span>
                  </Link>
                </li>
                {/* {modal && (
                  <>
                    <li>
                      <Link href="/admin/" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-blue-600 duration-500 group">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M9 18L15 12L9 6" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>

                        <span className="flex-1 ms-3 whitespace-nowrap text-lg">Active</span>
                      </Link>
                    </li>
                    <li>
                      <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-blue-600 duration-500 group">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path d="M9 18L15 12L9 6" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                        </svg>

                        <span className="flex-1 ms-3 whitespace-nowrap text-lg">Inactive</span>
                      </a>
                    </li>
                  </>
                )} */}
                <li>
                  <Link href="/admin/bookData" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-blue-600 duration-500 group">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                    ...
                    <span className="flex-1 ms-3 whitespace-nowrap text-lg">Book Database</span>
                  </Link>
                </li>
              </ul>
              <ul className="space-y-2">
